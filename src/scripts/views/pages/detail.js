...
import restoDetail from '../templates/detail-resto';
import PostReview from '../../utils/post-review';
import LikeButtonInitiator from '../../utils/button-like-initiator';
import { initSwalError } from '../../utils/swal-initiator';
import { sendDataToWebsocket } from '../../utils/websocket-initiator';
import favRestoIdb from '../../data/resto-fav-idb';
...
const Detail = {
  ...
  async afterRender() {
    ...
    const mainContainer = document.querySelector('#main-containt');
    ...
    try {
      const data = await RestoSource.getRestoDetail(url.id);
